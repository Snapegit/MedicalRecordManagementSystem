	...
	<div class="main-containers">
		...
		<div class="top-container" :style='{"boxShadow":"0 0px 0px rgba(64, 158, 255, .3)","padding":"0 10%","borderColor":"#eee","margin":"0 0 90px","alignItems":"center","color":"#666","textAlign":"right","display":"flex","justifyContent":"flex-end","top":"0","left":"0","background":"#e9e9e9","borderWidth":"0px","width":"100%","fontSize":"14px","position":"relative","borderStyle":"solid","height":"30px","zIndex":"1002"}'>
			...
			<div :style='{"margin":"0px 0 0","position":"absolute","top":"60px","float":"left","left":"10%","display":"block"}'>
			  <span :style='{"padding":"0 0 0 12px","lineHeight":"30px","fontSize":"36px","color":"#666","float":"left","fontWeight":"600"}'>基于 web 的病历管理系统的设计与实现</span>
			</div>
...
export default {
    data() {
		return {
            activeIndex: '0',
			roleMenus: [{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-rank","buttons":["新增","查看","修改","删除"],"menu":"患者","menuJump":"列表","tableName":"huanzhe"}],"menu":"患者管理"},{"child":[{"allButtons":["新增","查看","修改","删除","医生排班"],"appFrontIcon":"cuIcon-cardboard","buttons":["新增","查看","修改","删除","医生排班"],"menu":"医生","menuJump":"列表","tableName":"yisheng"}],"menu":"医生管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-copy","buttons":["新增","查看","修改","删除"],"menu":"科室","menuJump":"列表","tableName":"keshi"}],"menu":"科室管理"},{"child":[{"allButtons":["新增","查看","修改","删除","预约挂号"],"appFrontIcon":"cuIcon-list","buttons":["新增","查看","修改","删除","预约挂号"],"menu":"坐诊医生","menuJump":"列表","tableName":"zuozhenyisheng"}],"menu":"坐诊医生管理"},{"child":[{"allButtons":["新增","查看","修改","删除","支付","取消","病历登记","开具处方"],"appFrontIcon":"cuIcon-phone","buttons":["新增","查看","修改","删除","支付","取消","病历登记","开具处方"],"menu":"预约挂号","menuJump":"列表","tableName":"yuyueguahao"}],"menu":"预约挂号管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-qrcode","buttons":["新增","查看","修改","删除"],"menu":"挂号取消","menuJump":"列表","tableName":"guahaoquxiao"}],"menu":"挂号取消管理"},{"child":[{"allButtons":["新增","查看","修改","删除","病症症状","疾病诊断","首页总数","首页统计"],"appFrontIcon":"cuIcon-album","buttons":["新增","查看","修改","删除","首页总数","首页统计"],"menu":"电子病历","menuJump":"列表","tableName":"dianzibingli"}],"menu":"电子病历管理"},{"child":[{"allButtons":["新增","查看","修改","删除","支付","取药"],"appFrontIcon":"cuIcon-flashlightopen","buttons":["新增","查看","修改","删除","支付","取药"],"menu":"处方记录","menuJump":"列表","tableName":"chufangjilu"}],"menu":"处方记录管理"},{"child":[{"allButtons":["新增","查看","修改","删除","审核"],"appFrontIcon":"cuIcon-keyboard","buttons":["新增","查看","修改","删除","审核"],"menu":"取药记录","menuJump":"列表","tableName":"quyaojilu"}],"menu":"取药记录管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-copy","buttons":["新增","查看","修改","删除"],"menu":"药品类型","menuJump":"列表","tableName":"yaopinleixing"}],"menu":"药品类型管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-form","buttons":["新增","查看","修改","删除"],"menu":"药品信息","menuJump":"列表","tableName":"yaopinxinxi"}],"menu":"药品信息管理"},{"child":[{"allButtons":["新增","查看","修改","删除","住院登记"],"appFrontIcon":"cuIcon-wenzi","buttons":["新增","查看","修改","删除","住院登记"],"menu":"床位信息","menuJump":"列表","tableName":"chuangweixinxi"}],"menu":"床位信息管理"},{"child":[{"allButtons":["新增","查看","修改","删除","支付"],"appFrontIcon":"cuIcon-taxi","buttons":["新增","查看","修改","删除","支付"],"menu":"住院记录","menuJump":"列表","tableName":"zhuyuanjilu"}],"menu":"住院记录管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-vipcard","buttons":["新增","查看","修改","删除"],"menu":"轮播图管理","tableName":"config"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"公告栏","tableName":"news"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"公告栏分类","tableName":"newstype"}],"menu":"系统管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","预约挂号"],"appFrontIcon":"cuIcon-goods","buttons":["查看","预约挂号"],"menu":"坐诊医生列表","menuJump":"列表","tableName":"zuozhenyisheng"}],"menu":"坐诊医生模块"}],"hasBackLogin":"是","hasBackRegister":"否","hasFrontLogin":"否","hasFrontRegister":"否","roleName":"管理员","tableName":"users"},{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","支付","取消","病历登记","开具处方"],"appFrontIcon":"cuIcon-phone","buttons":["查看","支付","取消","删除"],"menu":"预约挂号","menuJump":"列表","tableName":"yuyueguahao"}],"menu":"预约挂号管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-qrcode","buttons":["查看","删除"],"menu":"挂号取消","menuJump":"列表","tableName":"guahaoquxiao"}],"menu":"挂号取消管理"},{"child":[{"allButtons":["新增","查看","修改","删除","病症症状","疾病诊断","首页总数","首页统计"],"appFrontIcon":"cuIcon-album","buttons":["查看"],"menu":"电子病历","menuJump":"列表","tableName":"dianzibingli"}],"menu":"电子病历管理"},{"child":[{"allButtons":["新增","查看","修改","删除","支付","取药"],"appFrontIcon":"cuIcon-flashlightopen","buttons":["查看","支付","取药"],"menu":"处方记录","menuJump":"列表","tableName":"chufangjilu"}],"menu":"处方记录管理"},{"child":[{"allButtons":["新增","查看","修改","删除","审核"],"appFrontIcon":"cuIcon-keyboard","buttons":["查看"],"menu":"取药记录","menuJump":"列表","tableName":"quyaojilu"}],"menu":"取药记录管理"},{"child":[{"allButtons":["新增","查看","修改","删除","支付"],"appFrontIcon":"cuIcon-taxi","buttons":["查看","支付"],"menu":"住院记录","menuJump":"列表","tableName":"zhuyuanjilu"}],"menu":"住院记录管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","预约挂号"],"appFrontIcon":"cuIcon-goods","buttons":["查看","预约挂号"],"menu":"坐诊医生列表","menuJump":"列表","tableName":"zuozhenyisheng"}],"menu":"坐诊医生模块"}],"hasBackLogin":"否","hasBackRegister":"否","hasFrontLogin":"是","hasFrontRegister":"是","roleName":"患者","tableName":"huanzhe"},{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","预约挂号"],"appFrontIcon":"cuIcon-list","buttons":["查看"],"menu":"坐诊医生","menuJump":"列表","tableName":"zuozhenyisheng"}],"menu":"坐诊医生管理"},{"child":[{"allButtons":["新增","查看","修改","删除","支付","取消","病历登记","开具处方"],"appFrontIcon":"cuIcon-phone","buttons":["查看","病历登记","开具处方"],"menu":"预约挂号","menuJump":"列表","tableName":"yuyueguahao"}],"menu":"预约挂号管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-qrcode","buttons":["查看"],"menu":"挂号取消","menuJump":"列表","tableName":"guahaoquxiao"}],"menu":"挂号取消管理"},{"child":[{"allButtons":["新增","查看","修改","删除","病症症状","疾病诊断","首页总数","首页统计"],"appFrontIcon":"cuIcon-album","buttons":["查看","修改","首页总数","首页统计"],"menu":"电子病历","menuJump":"列表","tableName":"dianzibingli"}],"menu":"电子病历管理"},{"child":[{"allButtons":["新增","查看","修改","删除","支付","取药"],"appFrontIcon":"cuIcon-flashlightopen","buttons":["查看"],"menu":"处方记录","menuJump":"列表","tableName":"chufangjilu"}],"menu":"处方记录管理"},{"child":[{"allButtons":["新增","查看","修改","删除","审核"],"appFrontIcon":"cuIcon-keyboard","buttons":["查看","审核"],"menu":"取药记录","menuJump":"列表","tableName":"quyaojilu"}],"menu":"取药记录管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-form","buttons":["查看"],"menu":"药品信息","menuJump":"列表","tableName":"yaopinxinxi"}],"menu":"药品信息管理"},{"child":[{"allButtons":["新增","查看","修改","删除","住院登记"],"appFrontIcon":"cuIcon-wenzi","buttons":["查看","住院登记"],"menu":"床位信息","menuJump":"列表","tableName":"chuangweixinxi"}],"menu":"床位信息管理"},{"child":[{"allButtons":["新增","查看","修改","删除","支付"],"appFrontIcon":"cuIcon-taxi","buttons":["查看"],"menu":"住院记录","menuJump":"列表","tableName":"zhuyuanjilu"}],"menu":"住院记录管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","预约挂号"],"appFrontIcon":"cuIcon-goods","buttons":["查看","预约挂号"],"menu":"坐诊医生列表","menuJump":"列表","tableName":"zuozhenyisheng"}],"menu":"坐诊医生模块"}],"hasBackLogin":"是","hasBackRegister":"是","hasFrontLogin":"否","hasFrontRegister":"否","roleName":"医生","tableName":"yisheng"}],
			baseUrl: '',
			carouselList: [],
			menuList: [],
			form: {
