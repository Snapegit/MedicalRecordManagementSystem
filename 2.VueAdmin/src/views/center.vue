  ...
  <div :style='{"width":"100%","padding":"30px","margin":"0","overflow-y":"auto","background":"#fff","height":"auto"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='huanzhe'"  label="年龄" prop="nianling">
          <el-input v-model="ruleForm.nianling"               placeholder="年龄" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='huanzhe'"  label="联系电话" prop="lianxidianhua">
          <el-input v-model="ruleForm.lianxidianhua"               placeholder="联系电话" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='huanzhe'"  label="身份证号码" prop="shenfenzhenghaoma">
          <el-input v-model="ruleForm.shenfenzhenghaoma"               placeholder="身份证号码" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='huanzhe'"  label="家庭住址" prop="jiatingzhuzhi">
        ...
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='yisheng'"  label="联系方式" prop="lianxifangshi">
          <el-input v-model="ruleForm.lianxifangshi"               placeholder="联系方式" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"margin":"0 0 20px 0"}'   v-if="flag=='yisheng'"  label="职位" prop="zhiwei">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if( 'huanzhe' ==this.flag && this.ruleForm.lianxidianhua&&(!isMobile(this.ruleForm.lianxidianhua))){
        this.$message.error(`联系电话应输入手机格式`);
        return
      }


      if( 'huanzhe' ==this.flag && this.ruleForm.shenfenzhenghaoma&&(!checkIdCard(this.ruleForm.shenfenzhenghaoma))){
