<template>
	<div class="main-content" :style='{"width":"100%","padding":"30px","margin":"0","overflow-y":"auto","background":"#fff","height":"auto"}'>
			...
			<el-form class="center-form-pv" :style='{"margin":"0 0 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"display":"block"}' >
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#666","display":"none","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">医生账号</label>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('yisheng','医生排班')" @click="zuozhenyishengCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
		...
		<zuozhenyisheng-cross-add-or-update v-if="zuozhenyishengCrossAddOrUpdateFlag" :parent="this" ref="zuozhenyishengCrossaddOrUpdate"></zuozhenyisheng-cross-add-or-update>
...
import zuozhenyishengCrossAddOrUpdate from "../zuozhenyisheng/add-or-update";
	export default {
		data() {
			return {
				searchForm: {
				...
				zuozhenyishengCrossAddOrUpdateFlag: false,
		...
		components: {
			AddOrUpdate,
			zuozhenyishengCrossAddOrUpdate,
		},
		methods: {
			contentStyleChange() {
			...
			zuozhenyishengCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
				this.addOrUpdateFlag = false;
				this.zuozhenyishengCrossAddOrUpdateFlag = true;
				...
				if(statusColumnName!=''&&!statusColumnName.startsWith("[")) {
					...
					for (var o in obj){
						if(o==statusColumnName && obj[o]==statusColumnValue){
							...
							this.showFlag = true;
							this.zuozhenyishengCrossAddOrUpdateFlag = false;
							return;
						}
					}
				}
				this.$nextTick(() => {
					this.$refs.zuozhenyishengCrossaddOrUpdate.init(row.id,type);
				});
			},
