	...
	<div class="addEdit-block" :style='{"width":"100%","padding":"50px 0 30px 0","margin":"0","overflow-y":"auto","background":"#fff","height":"auto"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.chuangweibianhao" label="床位编号" prop="chuangweibianhao">
					<el-input v-model="ruleForm.chuangweibianhao" placeholder="床位编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="床位状态" prop="chuangweizhuangtai">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="床位状态" prop="chuangweizhuangtai">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="床位费用" prop="chuangweifeiyong">
					<el-input v-model.number="ruleForm.chuangweifeiyong" placeholder="床位费用" clearable  :readonly="ro.chuangweifeiyong"></el-input>
				</el-form-item>
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				this.ruleForm.chuangweizhuangtai = '空闲'; 
			}
