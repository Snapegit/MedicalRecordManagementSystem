	...
	<div class="addEdit-block" :style='{"width":"100%","padding":"50px 0 30px 0","margin":"0","overflow-y":"auto","background":"#fff","height":"auto"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="开具处方" prop="kaijuchufang">
					<el-input v-model="ruleForm.kaijuchufang" placeholder="开具处方" clearable  :readonly="ro.kaijuchufang"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="开具处方" prop="kaijuchufang">
					<el-input v-model="ruleForm.kaijuchufang" placeholder="开具处方" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="服用方法" prop="fuyongfangfa">
					<el-input v-model="ruleForm.fuyongfangfa" placeholder="服用方法" clearable  :readonly="ro.fuyongfangfa"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="服用方法" prop="fuyongfangfa">
					<el-input v-model="ruleForm.fuyongfangfa" placeholder="服用方法" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="注意事项" prop="zhuyishixiang">
					<el-input v-model="ruleForm.zhuyishixiang" placeholder="注意事项" clearable  :readonly="ro.zhuyishixiang"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="注意事项" prop="zhuyishixiang">
					<el-input v-model="ruleForm.zhuyishixiang" placeholder="注意事项" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="处方费用" prop="chufangfeiyong">
					<el-input v-model.number="ruleForm.chufangfeiyong" placeholder="处方费用" clearable  :readonly="ro.chufangfeiyong"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="处方费用" prop="chufangfeiyong">
					<el-input v-model="ruleForm.chufangfeiyong" placeholder="处方费用" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="开具时间" prop="kaijushijian">
					<el-input v-model="ruleForm.kaijushijian" placeholder="开具时间" clearable  :readonly="ro.kaijushijian"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="开具时间" prop="kaijushijian">
					<el-input v-model="ruleForm.kaijushijian" placeholder="开具时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="取药时间" prop="quyaoshijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.quyaoshijian" 
						type="datetime"
						:readonly="ro.quyaoshijian"
						placeholder="取药时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.quyaoshijian" label="取药时间" prop="quyaoshijian">
					<el-input v-model="ruleForm.quyaoshijian" placeholder="取药时间" readonly></el-input>
				</el-form-item>
			</template>
...
export default {
	...
	created() {
		this.ruleForm.quyaoshijian = this.getCurDateTime()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='chufangfeiyong'){
							this.ruleForm.chufangfeiyong = obj[o];
							this.ro.chufangfeiyong = true;
							continue;
						}
						if(o=='kaijushijian'){
						...
						if(o=='quyaoshijian'){
							this.ruleForm.quyaoshijian = obj[o];
							this.ro.quyaoshijian = true;
							continue;
						}
				}
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `quyaojilu/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.quyaojiluCrossAddOrUpdateFlag = false;
											this.parent.search();
